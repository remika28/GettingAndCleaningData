...
<pre><code class="r">packages &lt;- c(&quot;data.table&quot;, &quot;reshape2&quot;)
...
<pre><code class="r">url &lt;- &quot;https://d396qusza40orc.cloudfront.net/getdata%2Fprojectfiles%2FUCI%20HAR%20Dataset.zip&quot;
f &lt;- &quot;Dataset.zip&quot;
if (!file.exists(path)) {
    dir.create(path)
}
...
<pre><code class="r">executable &lt;- file.path(&quot;C:&quot;, &quot;Program Files (x86)&quot;, &quot;7-Zip&quot;, &quot;7z.exe&quot;)
parameters &lt;- &quot;x&quot;
...
<pre><code class="r">pathIn &lt;- file.path(path, &quot;UCI HAR Dataset&quot;)
...
<pre><code class="r">dtSubjectTrain &lt;- fread(file.path(pathIn, &quot;train&quot;, &quot;subject_train.txt&quot;))
...
<pre><code class="r">dtActivityTrain &lt;- fread(file.path(pathIn, &quot;train&quot;, &quot;Y_train.txt&quot;))
...
<pre><code class="r">fileToDataTable &lt;- function(f) {
    df &lt;- read.table(f)
    dt &lt;- data.table(df)
}
...
<h2>Merge the training and the test sets</h2>

<p>Concatenate the data tables.</p>

<pre><code class="r">dtSubject &lt;- rbind(dtSubjectTrain, dtSubjectTest)
...
<pre><code class="r">dtSubject &lt;- cbind(dtSubject, dtActivity)
dt &lt;- cbind(dtSubject, dt)
</code></pre>

<p>Set key.</p>

<pre><code class="r">setkey(dt, subject, activityNum)
</code></pre>

<h2>Extract only the mean and standard deviation</h2>
...
<pre><code class="r">dtFeatures &lt;- fread(file.path(pathIn, &quot;features.txt&quot;))
setnames(dtFeatures, names(dtFeatures), c(&quot;featureNum&quot;, &quot;featureName&quot;))
</code></pre>

<p>Subset only measurements for the mean and standard deviation.</p>

<pre><code class="r">dtFeatures &lt;- dtFeatures[grepl(&quot;mean\\(\\)|std\\(\\)&quot;, featureName)]
</code></pre>

<p>Convert the column numbers to a vector of variable names matching columns in <code>dt</code>.</p>

<pre><code class="r">dtFeatures$featureCode &lt;- dtFeatures[, paste0(&quot;V&quot;, featureNum)]
head(dtFeatures)
</code></pre>
...
<pre><code class="r">dtFeatures$featureCode
</code></pre>
...
<pre><code class="r">select &lt;- c(key(dt), dtFeatures$featureCode)
dt &lt;- dt[, select, with = FALSE]
</code></pre>

<h2>Use descriptive activity names</h2>

<p>Read <code>activity_labels.txt</code> file. This will be used to add descriptive names to the activities.</p>

<pre><code class="r">dtActivityNames &lt;- fread(file.path(pathIn, &quot;activity_labels.txt&quot;))
setnames(dtActivityNames, names(dtActivityNames), c(&quot;activityNum&quot;, &quot;activityName&quot;))
</code></pre>

<h2>Label with descriptive activity names</h2>

<p>Merge activity labels.</p>

<pre><code class="r">dt &lt;- merge(dt, dtActivityNames, by = &quot;activityNum&quot;, all.x = TRUE)
</code></pre>

<p>Add <code>activityName</code> as a key.</p>

<pre><code class="r">setkey(dt, subject, activityNum, activityName)
</code></pre>

<p>Melt the data table to reshape it from a short and wide format to a tall and narrow format.</p>

<pre><code class="r">dt &lt;- data.table(melt(dt, key(dt), variable.name = &quot;featureCode&quot;))
</code></pre>

<p>Merge activity name.</p>

<pre><code class="r">dt &lt;- merge(dt, dtFeatures[, list(featureNum, featureCode, featureName)], by = &quot;featureCode&quot;, 
    all.x = TRUE)
</code></pre>
...
<pre><code class="r">r1 &lt;- nrow(dt[, .N, by = c(&quot;feature&quot;)])
...
<h2>Create a tidy data set</h2>

<p>Create a data set with the average of each variable for each activity and each subject.</p>

<pre><code class="r">setkey(dt, subject, activity, featDomain, featAcceleration, featInstrument, 
    featJerk, featMagnitude, featVariable, featAxis)
...
<pre><code class="r">knit(&quot;makeCodebook.Rmd&quot;, output = &quot;codebook.md&quot;, encoding = &quot;ISO8859-1&quot;, quiet = TRUE)
</code></pre>
